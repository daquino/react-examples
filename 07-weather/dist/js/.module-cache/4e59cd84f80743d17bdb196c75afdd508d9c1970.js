    ...
    return (
      ...
      React.createElement("form", {className: "form-inline", onSubmit: this.retrieveForecast}, 
        React.createElement("div", {className: "form-group"}, 
          ...
          React.createElement("button", {type: "submit", className: "btn btn-primary"}, "Get Forecast")
        )
      )
      )
    );
...
var ForecastItem = React.createClass({displayName: "ForecastItem",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "col-lg-1 col-centered forecastItem", style: style, onClick: this.handleClick}, 
