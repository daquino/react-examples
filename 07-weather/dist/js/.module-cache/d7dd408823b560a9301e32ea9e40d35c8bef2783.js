...
var Forecast = React.createClass({displayName: "Forecast",
  ...
  render: function() {
    var forecastItems = this.props.forecastItems.map(function(forecastItem, index) {
      ...
      return React.createElement(ForecastItem, {key: index, forecastItem: forecastItem, selected: selected})
    });
    return (
...
var ForecastItem = React.createClass({displayName: "ForecastItem",
  ...
  render: function() {
    ...
    var itemClass = this.props.selected ? "col-md-1 col-centered" : "col-md-1 col-centered bg-warning";
    return (
      React.createElement("div", {className: itemClass, onClick: this.handleClick}, 
