    ...
    return (
        React.createElement("div", {className: "container text-center"}, 
          ...
          React.createElement("div", {id: "locationForm", className: "row"}, 
            React.createElement(LocationForm, {retrieveForecast: this.retrieveForecast, forecastAttempted: this.state.forecastAttempted, forecastFound: this.state.forecastFound})
          ), 
  ...
  render: function() {
    ...
    if(this.props.forecastAttempted) {
      if(this.props.forecastFound) {
        ...
        locationFeedback = React.createElement("span", {class: "glyphicon glyphicon-ok form-control-feedback", "aria-hidden": "true"})
      }
      else {
        locationGroupClass += " has-feedback has-failure";
        locationFeedback = React.createElement("span", {class: "glyphicon glyphicon-remove form-control-feedback", "aria-hidden": "true"})
      }
    }
    return (
