...
var WeatherApp = React.createClass({displayName: "WeatherApp",
  retrieveForecast: function(location) {
    ...
    .done(this.processForecastResponse)
    .fail(this.processForecastFailure);
  },
  processForecastResponse: function (response) {
    var forecast;
    var forecastFound;
    if(response.cod == "200") {
...
var LocationForm = React.createClass({displayName: "LocationForm",
  ...
  buildLocationFeedback: function() {
    ...
    if(this.props.forecastAttempted) {
      if(this.props.forecastFound) {
        locationFeedback = React.createElement("span", {className: "glyphicon wi-day-sunny form-control-feedback", "aria-hidden": "true"})
      }
      else {
      ...
      locationFeedback = React.createElement("span", {className: "glyphicon wi-day-sunny glyphicon-refresh-animate form-control-feedback", "aria-hidden": "true"})
    }
