var WeatherApp = React.createClass({displayName: "WeatherApp",
  ...
  render: function() {
    ...
    var forecastContent = this.state.isLoadingForecast ? React.createElement(ForecastLoading, {location: this.state.location}) : React.createElement(Forecast, null)
    return (
...
var ForecastLoading = React.createClass({displayName: "ForecastLoading",

  render: function() {
    return (
        React.createElement("h1", null, "Loading forecast for ", this.props.location, ", TN...")
    );
  }
